...
customElements.define(elementName, class extends HTMLElement {
    ...
    private render(): string {
        const style = require('!raw-loader!./layout-logo.style.css');

        return this.innerHTML = `
          <style>${style.default}</style>
          <div class="layout-logo">
            <svg xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#" xmlns="http://www.w3.org/2000/svg" xmlns:cc="http://web.resource.org/cc/" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:svg="http://www.w3.org/2000/svg" id="svg2168" viewBox="0 0 292.79 242.95" version="1.0"><link xmlns="" type="text/css" rel="stylesheet" id="dark-mode-general-link"/><link xmlns="" type="text/css" rel="stylesheet" id="dark-mode-custom-link"/><style xmlns="" lang="en" type="text/css" id="dark-mode-custom-style"/>
